...
<template>
  <section>
    ...
    <div class="settings-layout">
      <div class="panel execution-panel">
        <div class="panel-heading">
          ...
          <div><h3>浏览器与任务参数</h3><p>&lt;安装目录&gt;\data\settings.json</p></div>
    ...
    <div class="proxy-heading">
      <div>
        <h2>代理池与直接导入</h2>
        <p>支持 HTTP、HTTPS、SOCKS5 / SOCKS5H；可直接粘贴或上传 TXT / YAML，无需 EasyProxy、Clash 等外部管理器。</p>
      </div>
      <div class="toolbar-group">
        ...
        <el-button
          ...
          @click="testProxies()"
        >检测全部</el-button>
        <el-button type="primary" :icon="DocumentAdd" @click="importOpen = true">导入 HTTP / SOCKS</el-button>
      </div>
    </div>
...
.api-settings-card {
  ...
  border: 1px solid rgb(213 175 0 / 25%);
  border-radius: 12px;
  background: rgb(213 175 0 / 6%);
}
