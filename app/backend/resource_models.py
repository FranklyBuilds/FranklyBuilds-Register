...
RunKind = Literal["mock", "browser_probe", "protocol_registration"]
...
class ProtocolRegistrationRunCreate(BrowserProbeRunCreate):
    """Start the direct HTTP registration flow with the same resource filters."""
